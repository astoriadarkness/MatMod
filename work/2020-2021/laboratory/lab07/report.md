...
3.	$\frac{dn}{dt} = (0.196*sin(t) + 0.3t*cos(t)*n(t))(N-n(t))$

При этом объем аудитории $N = 1170$, в начальный момент о товаре знает 7 человек.
...
![График для случая 3](image/3.png){ #fig:005 width=70% height=70% }
