...
![Жесткая модель войны](image/3.png){ #fig:001 width=70% height=70% }
...
![Фазовые траектории для второго случая](image/4.png){ #fig:002 width=70% height=70% }
